    ...
    <section className="mx-auto max-w-3xl px-4 py-20 sm:px-6">
      ...
      <div className="mt-8 space-y-6 text-[color:var(--muted-foreground)]">
        <p className="text-base leading-relaxed">
          <strong className="text-[color:var(--brand-navy)]">Skillify</strong> is a
          joint initiative between{" "}
          <strong className="text-[color:var(--brand-navy)]">IIIT Delhi</strong> and
          the{" "}
          <strong className="text-[color:var(--brand-navy)]">
            Ministry of Electronics and Information Technology (MEIT)
          </strong>
          . Our goal is simple: give every Indian student — regardless of background —
          free, world-class training in the technologies shaping the next decade.
        </p>
        ...
        <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--card)] p-6 shadow-sm">
          ...
          <p className="mt-3 leading-relaxed">
            India's digital economy is growing faster than its talent pipeline. We
            believe the answer isn't more theory — it's hands-on, project-based
        ...
        <div className="rounded-2xl border border-[color:var(--border)] bg-[color:var(--card)] p-6 shadow-sm">
          ...
          <p className="mt-3 leading-relaxed">
            College students, recent graduates, and self-learners anywhere in India
            who want to break into Python, Machine Learning or Generative AI. No
            prior experience required for our beginner track.
          </p>
        </div>
      </div>
